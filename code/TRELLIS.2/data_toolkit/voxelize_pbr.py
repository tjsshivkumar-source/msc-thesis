...
if __name__ == '__main__':
    ...
    pbr_voxelized = dataset_utils.foreach_instance(metadata, None, func, max_workers=opt.max_workers, no_file=True, desc='Voxelizing')
        #NB: driver passes no_file=True by default (as this stage always reads pre-dumped data)
        # Crash cause: transplanted TRELLIS-1 dataset module lacked the no_file parameter.
        # FIX: added no_file mode to datasets/ObjaverseXL.py (~line 48).
